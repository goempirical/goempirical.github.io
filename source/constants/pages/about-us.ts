...
export const texts = {
  ...
  ourApproach: {
    title: 'Team members are saying',
    items: [
      {
        title: 'Strategic thinking',
        content: 'Lorem ipsum dolor sit amet, consectetur incididunt ut labore et dolore magna aliqua.',
      },
      {
  ...
  ourTeam: {
    ...
    items: [
      ...
      {
        image: lucasZibellImage,
        title: 'Lucas Zibell',
        content: 'Sr. Technical Interviewer - Argentina',
        link: 'https://www.linkedin.com/in/lucas-zibell/',
      },
      {
      ...
      },
      {
        ...
        title: 'Santiago Parra',
        content: 'Sr. Software Engineer - Colombia',
        link: 'https://www.linkedin.com/in/santiago-parra-9b40241b0/',
      },
      {
